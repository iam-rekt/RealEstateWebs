    ...
    <footer className="bg-text-primary text-white py-12" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4 space-x-reverse justify-end">
              <a href={facebookUrl || "#"} target={facebookUrl && facebookUrl !== "#" ? "_blank" : "_self"} rel="noopener noreferrer" className="text-white hover:text-gray-200 transition-colors duration-200">
                <Facebook className="h-6 w-6" />
              </a>
              <a href={instagramUrl || "#"} target={instagramUrl && instagramUrl !== "#" ? "_blank" : "_self"} rel="noopener noreferrer" className="text-white hover:text-gray-200 transition-colors duration-200">
                <Instagram className="h-6 w-6" />
              </a>
              <a href={linkedinUrl || "#"} target={linkedinUrl && linkedinUrl !== "#" ? "_blank" : "_self"} rel="noopener noreferrer" className="text-white hover:text-gray-200 transition-colors duration-200">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-white text-sm">&copy; 2024 {companyName}. جميع الحقوق محفوظة.</p>
